...
code_interp_plot_TSGdatapath <- file.path(source_code_directory, "2code_interp_plot_TSGdata")
if(!dir.exists(file.path(code_interp_plot_TSGdatapath))) {
    dir.create(file.path(code_interp_plot_TSGdatapath))
}
